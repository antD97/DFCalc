    ...
    >
      <Box className="flex flex-col w-auto self-center mb-6">
        ...
        <div className="relative flex justify-center items-center text-2xl pb-4">
          <H level="2" className="text-2xl">Game Data</H>
          <Tooltip
            title={
              <div className="text-sm">
                ...
                <ol className="list-decimal ml-4 flex flex-col gap-y-4 pb-4">
                  <li>
          ...
          <div className={isLoading ? 'opacity-25' : ''}>
            <fieldset disabled={isLoading}>
              ...
              <div className="pb-4">
                ...
                <Input ref={loadUrlInput} placeholder="https://dfcalc.antd.xyz/data/havoc-warfare-2024.08.26.json" className="w-96" />
                <Button
                  className="ml-4"
                  onClick={() => {
              ...
              <H level="2" className="text-2xl pb-4 text-center">Current Game Data</H>

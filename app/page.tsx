...
export default function Home() {
  return (
    <>
      ...
      <Box className="bg-transparent mb-4 pt-0">
        <P>
          DFCalc is a calculator tool designed for the game <A href="">Delta Force</A>. Here you can find various tools
        ...
        <P>
          ...
          mistakes. If you find any problems with the data that don't match what you're experience in-game, visit
          the <A href="issues">issues</A> page to help correct it. If you'd like to help keep this tool's up-to-date
          visit the <A href="contribute">contribute</A> page to see how you can help. All of the raw data used by the
